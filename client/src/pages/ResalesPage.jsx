                                ...
                                <tr key={resale._id}>
                                    <td>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                            <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: 'rgba(187, 182, 182, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', fontWeight: '700', color: 'var(--success)' }}>
                                            <DollarSign size={14} />
                                            {resale.resalePrice ? resale.resalePrice.toLocaleString() : (resale.event?.price || 0).toLocaleString()} <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: '400' }}>(requested)</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
                                            <button 
                                                ...
                                                style={{ display: 'flex', alignItems: 'center', gap: '6px', background: 'rgba(240, 246, 244, 0.1)', border: '1px solid rgba(255, 255, 255, 0.2)', color: 'var(--success)', cursor: 'pointer', padding: '8px 12px', borderRadius: '8px', fontWeight: '600', fontSize: '13px', transition: '0.2s' }}
